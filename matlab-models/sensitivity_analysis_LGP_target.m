...
for i = 1:10
    ...
    % === Objective Function ===
    prob.Objective = n(1) + n(2) + n(5) + n(10);
    ...
    priority_objective_1_fvals(i)     = fval;
        ...
        prob.Constraints.cons13 = n(1) + n(2) + n(5) + n(10) == priority_objective_1_fvals(i);
        ...
        prob.Constraints.cons14 = p(3) + p(4) + n(6) == priority_objective_2_fvals(i);
