...
disp(K_sets);
    ...
    %% LGP - Target Sensitivity Analysis - Priority 1
    
    % Preallocate storage
    priority_objective_1_sols = cell(10,1);
    priority_objective_1_fvals = zeros(10,1);
    
    priority_objective_2_sols = cell(10,1);
    priority_objective_2_fvals = zeros(10,1);
    
    priority_objective_3_sols     = cell(10,1);   
    priority_objective_3_fvals    = zeros(10,1); 
    ...
    for i = 1:10
        ...
        % === Objective Function ===
        prob.Objective = curr_set(1)*(1/47)*n(1) + curr_set(2)*(1/3)*n(2) + curr_set(5)*(1/0.52)*n(5) + curr_set(10)*(1/0.68)*n(10); 
        ...
        [sol,fval_temp,exitflag] = intlinprog(problem);
        fval = NaN;
        ...
        % store results
        priority_objective_1_sols{i}      = sol;
        priority_objective_1_fvals(i)     = fval;
        ...
        % === Objective Function ===
        prob.Objective = curr_set(3)*(1/0.04)*p(3) + curr_set(4)*(1/48.74)*p(4) + curr_set(6)*(1/22.07)*n(6); 
        ...
        prob.Constraints.cons13 = curr_set(1)*(1/47)*n(1) + curr_set(2)*(1/3)*n(2) + curr_set(5)*(1/0.52)*n(5) + curr_set(10)*(1/0.68)*n(10) == priority_objective_1_fvals(i);
        ...
        % store results
        priority_objective_2_sols{i}      = sol;
        priority_objective_2_fvals(i)     = fval;
        ...
        % === Objective Function ===
        prob.Objective = curr_set(7)*(1/0.35)*p(7) + curr_set(8)*(1/0.32)*p(8) + curr_set(9)*(1/23)*p(9); 
        ...
        prob.Constraints.cons13 = curr_set(1)*(1/47)*n(1) + curr_set(2)*(1/3)*n(2) + curr_set(5)*(1/0.52)*n(5) + curr_set(10)*(1/0.68)*n(10) == priority_objective_1_fvals(i);
        prob.Constraints.cons14 = curr_set(3)*(1/0.04)*p(3) + curr_set(4)*(1/48.74)*p(4) + curr_set(6)*(1/22.07)*n(6) == priority_objective_2_fvals(i);
        ...
        % store results
        priority_objective_3_sols{i}      = sol;
        priority_objective_3_fvals(i)     = fval;
    end
